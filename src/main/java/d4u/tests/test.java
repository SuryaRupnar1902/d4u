...
//                "C:\\Users\\LENOVO\\Downloads\\chromedriver-win64\\chromedriver.exe");
        ...
        try {
            ...
            search.sendKeys("OFFER-2024-09-0098960");
            ...
            WebElement lookupIcon = wait.until(ExpectedConditions.elementToBeClickable(
                    By.xpath("(//img[@alt='Customer Name Lookup (New Window)'])")));
            lookupIcon.click();
         ...
         // Tab key 4 times with a 0.2 sec wait
            ...
            actions1.sendKeys("003Id000003f4asIAA").sendKeys("\uE007").perform();  // Perform the actions
